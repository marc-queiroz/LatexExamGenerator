...
\begin{mdframed}[userdefinedwidth=1.0\textwidth,align=center,frametitle={Instruções}]
	...
	\begin{mdframed}[align=left]
		\textbf{Nome: 05 - NOME COMPLETO DO ALUNO 5}
		\\
		\\Assinatura:
	\end{mdframed}
...
\begin{questions}
\input{question.9/exercise.7}
\input{question.3/exercise.5}
\input{question.2/exercise.3}
\input{question.7/exercise.0}
\input{question.8/exercise.8}
\input{question.6/exercise.5}
\input{question.1/exercise.10}
\input{question.5/exercise.2}
\input{question.0/exercise.3}
\input{question.4/exercise.6}
\end{questions}
