...
\begin{questions}
\input{question.2/exercise.10}
\input{question.3/exercise.7}
\input{question.0/exercise.5}
\input{question.6/exercise.8}
\input{question.4/exercise.10}
\input{question.9/exercise.2}
\input{question.5/exercise.10}
\input{question.1/exercise.1}
\input{question.8/exercise.10}
\input{question.7/exercise.7}
\end{questions}
