...
\begin{mdframed}[userdefinedwidth=1.0\textwidth,align=center,frametitle={Instruções}]
	...
	\begin{mdframed}[align=left]
		\textbf{Nome: 09 - NOME COMPLETO DO ALUNO 9}
		\\
		\\Assinatura:
	\end{mdframed}
...
\begin{questions}
\input{question.5/exercise.1}
\input{question.8/exercise.0}
\input{question.3/exercise.8}
\input{question.6/exercise.3}
\input{question.0/exercise.2}
\input{question.9/exercise.0}
\input{question.4/exercise.5}
\input{question.2/exercise.3}
\input{question.1/exercise.4}
\input{question.7/exercise.10}
\end{questions}
