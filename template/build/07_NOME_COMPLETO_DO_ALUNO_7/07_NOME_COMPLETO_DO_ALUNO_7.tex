...
\begin{mdframed}[userdefinedwidth=1.0\textwidth,align=center,frametitle={Instruções}]
	...
	\begin{mdframed}[align=left]
		\textbf{Nome: 07 - NOME COMPLETO DO ALUNO 7}
		\\
		\\Assinatura:
	\end{mdframed}
...
\input{question.0/exercise.4}
\input{question.2/exercise.5}
\input{question.4/exercise.1}
\input{question.1/exercise.5}
\input{question.3/exercise.6}
\input{question.7/exercise.6}
\input{question.5/exercise.1}
\input{question.8/exercise.3}
\input{question.9/exercise.3}
\end{questions}
